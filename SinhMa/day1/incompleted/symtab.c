...
int sizeOfType(Type* type) {
  ...
  switch(type->typeClass)
  {
    case TP_INT: size = INT_SIZE; break;
    case TP_CHAR: size = CHAR_SIZE; break;
    case TP_ARRAY: size = (type->arraySize) * sizeOfType(type->elementType); break;
  }
...
void declareObject(Object* obj) {
  ...
  else
  {
    switch(obj->kind)
    {
      ...
      default: addObject(&symtab->currentScope->objList, obj); break;
    }
  }
}
